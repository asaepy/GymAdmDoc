...
@NamedQueries({
   ...
   @NamedQuery(name = "MruDia.findByRuId", query = "SELECT m FROM MruDia m WHERE m.ruId = :ruId"),
...
public class MruDia implements Serializable {
   ...
   public MruDia(Integer diaId, int ruId, String diaNumero, Date diaTiempomin) {
      this.diaId = diaId;
      this.ruId = ruId;
