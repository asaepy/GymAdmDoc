...
@NamedQueries({
   ...
   @NamedQuery(name = "MuFuerzaMuscular.findByEvalId", query = "SELECT m FROM MuFuerzaMuscular m WHERE m.evalId = :evalId"),
...
public class MuFuerzaMuscular implements Serializable {
   ...
   public MuFuerzaMuscular(Integer fumusId, long evalId, float fumusBancoPecho, float fumusExtMaquina, float fumusLatMaquina, float fumusCurlFemoral, float fumusCurlBiceps, float fumusCalfPantorrilla, float fumusTricepsPolea, float fumusExtGluteo) {
      this.fumusId = fumusId;
      this.evalId = evalId;
   ...
   public String toString() {
      return "co.edu.unicauca.gymadmdoc.entities.MuFuerzaMuscular[ fumusId=" + fumusId + " ]";
   }
