...
@NamedQueries({
   ...
   @NamedQuery(name = "MuResisteciaCardiorespiratorio.findByEvalId", query = "SELECT m FROM MuResisteciaCardiorespiratorio m WHERE m.evalId = :evalId"),
...
public class MuResisteciaCardiorespiratorio implements Serializable {
   ...
   public MuResisteciaCardiorespiratorio(Integer rescaId, long evalId, float rescaFrecuenciaReposo, float rescaFrecuenciaMin, String rescaClasificacion) {
      this.rescaId = rescaId;
      this.evalId = evalId;
   ...
   public String toString() {
      return "co.edu.unicauca.gymadmdoc.entities.MuResisteciaCardiorespiratorio[ rescaId=" + rescaId + " ]";
   }
