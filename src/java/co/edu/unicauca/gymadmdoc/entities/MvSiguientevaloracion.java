...
@NamedQueries({
   ...
   @NamedQuery(name = "MvSiguientevaloracion.findByUsuIdentificacion", query = "SELECT m FROM MvSiguientevaloracion m WHERE m.usuIdentificacion = :usuIdentificacion"),
...
public class MvSiguientevaloracion implements Serializable {
   ...
   public String toString() {
      return "co.edu.unicauca.gymadmdoc.entities.MvSiguientevaloracion[ sigId=" + sigId + " ]";
   }
