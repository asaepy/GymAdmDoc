...
@NamedQueries({
   ...
   @NamedQuery(name = "MuAntecedentesTipoa.findByAnsaId", query = "SELECT m FROM MuAntecedentesTipoa m WHERE m.ansaId = :ansaId"),
...
public class MuAntecedentesTipoa implements Serializable {
   ...
   public MuAntecedentesTipoa(Integer antaId, int ansaId, String antaPregunta, boolean antaRespuesta) {
      this.antaId = antaId;
      this.ansaId = ansaId;
   ...
   public String toString() {
      return "co.edu.unicauca.gymadmdoc.entities.MuAntecedentesTipoa[ antaId=" + antaId + " ]";
   }
