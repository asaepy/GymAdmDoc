...
@NamedQueries({
   ...
   @NamedQuery(name = "MuFuerzaAbdominal.findByEvalId", query = "SELECT m FROM MuFuerzaAbdominal m WHERE m.evalId = :evalId"),
...
public class MuFuerzaAbdominal implements Serializable {
   ...
   public MuFuerzaAbdominal(Integer fuabId, long evalId, float fuabSitUp, float fuabPlancha, String fuabClasificacion) {
      this.fuabId = fuabId;
      this.evalId = evalId;
   ...
   public String toString() {
      return "co.edu.unicauca.gymadmdoc.entities.MuFuerzaAbdominal[ fuabId=" + fuabId + " ]";
   }
