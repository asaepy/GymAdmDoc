...
import co.edu.unicauca.gymadmdoc.entities.MvSiguientevaloracion;
...
import co.edu.unicauca.gymadmdoc.sessionbeans.MvSiguientevaloracionFacade;
...
public class MvSiguientevaloracionController implements Serializable {
   ...
   private MvSiguientevaloracion current;
   private DataModel items = null;
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.MvSiguientevaloracionFacade ejbFacade;
   ...
   public MvSiguientevaloracion getSelected() {
      if (current == null) {
         current = new MvSiguientevaloracion();
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public String prepareView() {
      current = (MvSiguientevaloracion) getItems().getRowData();
   ...
   public String create() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvSiguientevaloracionCreated"));
   ...
   public String update() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvSiguientevaloracionUpdated"));
         return "View";
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
         return null;
   ...
   private void performDestroy() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvSiguientevaloracionDeleted"));
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
      }
   }
   ...
   public static class MvSiguientevaloracionControllerConverter implements Converter {
      ...
      public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
         ...
         if (object instanceof MvSiguientevaloracion) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MvSiguientevaloracion.class.getName());
         }
      }
