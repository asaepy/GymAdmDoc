...
import co.edu.unicauca.gymadmdoc.sessionbeans.MuFacultadDependenciaFacade;
...
public class MuFacultadDependenciaController implements Serializable {
   ...
   private MuFacultadDependencia current;
   private DataModel items = null;
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.MuFacultadDependenciaFacade ejbFacade;
   ...
   public MuFacultadDependencia getSelected() {
      if (current == null) {
         current = new MuFacultadDependencia();
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public String prepareView() {
      current = (MuFacultadDependencia) getItems().getRowData();
   ...
   public String create() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MuFacultadDependenciaCreated"));
   ...
   public String update() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MuFacultadDependenciaUpdated"));
         return "View";
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
         return null;
   ...
   private void performDestroy() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MuFacultadDependenciaDeleted"));
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
      }
   }
   ...
   public static class MuFacultadDependenciaControllerConverter implements Converter {
      ...
      public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
         ...
         if (object instanceof MuFacultadDependencia) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MuFacultadDependencia.class.getName());
         }
      }
