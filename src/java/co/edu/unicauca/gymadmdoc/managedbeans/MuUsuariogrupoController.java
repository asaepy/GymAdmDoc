...
import co.edu.unicauca.gymadmdoc.sessionbeans.MuUsuariogrupoFacade;
...
public class MuUsuariogrupoController implements Serializable {
   ...
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.MuUsuariogrupoFacade ejbFacade;
   ...
   public MuUsuariogrupo getSelected() {
      if (current == null) {
         ...
         current.setMuUsuariogrupoPK(new co.edu.unicauca.gymadmdoc.entities.MuUsuariogrupoPK());
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public MuUsuariogrupo getMuUsuariogrupo(co.edu.unicauca.gymadmdoc.entities.MuUsuariogrupoPK id) {
   ...
   public static class MuUsuariogrupoControllerConverter implements Converter {
      ...
      co.edu.unicauca.gymadmdoc.entities.MuUsuariogrupoPK getKey(String value) {
         co.edu.unicauca.gymadmdoc.entities.MuUsuariogrupoPK key;
         String values[] = value.split(SEPARATOR_ESCAPED);
         key = new co.edu.unicauca.gymadmdoc.entities.MuUsuariogrupoPK();
         key.setGruId(Long.parseLong(values[0]));
         key.setUsuIdentificacion(Long.parseLong(values[1]));
         return key;
      }

      String getStringKey(co.edu.unicauca.gymadmdoc.entities.MuUsuariogrupoPK value) {
