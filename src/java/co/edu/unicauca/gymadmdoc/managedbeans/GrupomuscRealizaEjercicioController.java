...
import co.edu.unicauca.gymadmdoc.sessionbeans.GrupomuscRealizaEjercicioFacade;
...
public class GrupomuscRealizaEjercicioController implements Serializable {
   ...
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.GrupomuscRealizaEjercicioFacade ejbFacade;
   ...
   public GrupomuscRealizaEjercicio getSelected() {
      if (current == null) {
         ...
         current.setGrupomuscRealizaEjercicioPK(new co.edu.unicauca.gymadmdoc.entities.GrupomuscRealizaEjercicioPK());
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public GrupomuscRealizaEjercicio getGrupomuscRealizaEjercicio(co.edu.unicauca.gymadmdoc.entities.GrupomuscRealizaEjercicioPK id) {
   ...
   public static class GrupomuscRealizaEjercicioControllerConverter implements Converter {
      ...
      co.edu.unicauca.gymadmdoc.entities.GrupomuscRealizaEjercicioPK getKey(String value) {
         co.edu.unicauca.gymadmdoc.entities.GrupomuscRealizaEjercicioPK key;
         String values[] = value.split(SEPARATOR_ESCAPED);
         key = new co.edu.unicauca.gymadmdoc.entities.GrupomuscRealizaEjercicioPK();
         key.setGmId(Integer.parseInt(values[0]));
         key.setEjId(Integer.parseInt(values[1]));
         return key;
      }

      String getStringKey(co.edu.unicauca.gymadmdoc.entities.GrupomuscRealizaEjercicioPK value) {
