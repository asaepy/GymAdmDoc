...
import co.edu.unicauca.gymadmdoc.sessionbeans.MvValoracionFacade;
...
public class MvValoracionController implements Serializable {
   ...
   private MvValoracion current;
   private DataModel items = null;
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.MvValoracionFacade ejbFacade;
   ...
   public String prepareView() {
      current = (MvValoracion) getItems().getRowData();
   ...
   public String create() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvValoracionCreated"));
   ...
   public String update() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvValoracionUpdated"));
         return "View";
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
         return null;
   ...
   private void performDestroy() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvValoracionDeleted"));
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
      }
   }
   ...
   public static class MvValoracionControllerConverter implements Converter {
      ...
      public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
         ...
         if (object instanceof MvValoracion) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MvValoracion.class.getName());
         }
      }
