...
import co.edu.unicauca.gymadmdoc.entities.UploadImage;
...
import co.edu.unicauca.gymadmdoc.sessionbeans.UploadImageFacade;
...
public class UploadImageController implements Serializable {
   ...
   private UploadImage current;
   private DataModel items = null;
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.UploadImageFacade ejbFacade;
   ...
   public String prepareView() {
      current = (UploadImage) getItems().getRowData();
   ...
   public String create() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UploadImageCreated"));
   ...
   public String update() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UploadImageUpdated"));
         return "View";
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
         return null;
   ...
   private void performDestroy() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UploadImageDeleted"));
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
      }
   }
   ...
   public UploadImage getUploadImage(java.lang.Long id) {
   ...
   public static class UploadImageControllerConverter implements Converter {
      ...
      public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
         ...
         if (object instanceof UploadImage) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + UploadImage.class.getName());
         }
      }
