...
import co.edu.unicauca.gymadmdoc.sessionbeans.MvRegistrofotograficoFacade;
...
public class MvRegistrofotograficoController implements Serializable {
   ...
   private MvRegistrofotografico current;
   private DataModel items = null;
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.MvRegistrofotograficoFacade ejbFacade;
   ...
   public MvRegistrofotografico getSelected() {
      if (current == null) {
         current = new MvRegistrofotografico();
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public String prepareView() {
      current = (MvRegistrofotografico) getItems().getRowData();
   ...
   public String create() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvRegistrofotograficoCreated"));
   ...
   public String update() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvRegistrofotograficoUpdated"));
         return "View";
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
         return null;
   ...
   private void performDestroy() {
      try {
         ...
         JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MvRegistrofotograficoDeleted"));
      } catch (Exception e) {
         JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
      }
   }
   ...
   public static class MvRegistrofotograficoControllerConverter implements Converter {
      ...
      public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
         ...
         if (object instanceof MvRegistrofotografico) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MvRegistrofotografico.class.getName());
         }
      }
