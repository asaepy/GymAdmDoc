...
import co.edu.unicauca.gymadmdoc.entities.MaDetalleasistencia;
...
import co.edu.unicauca.gymadmdoc.sessionbeans.MaDetalleasistenciaFacade;
...
public class MaDetalleasistenciaController implements Serializable {
   ...
   @EJB
   private co.edu.unicauca.gymadmdoc.sessionbeans.MaDetalleasistenciaFacade ejbFacade;
   ...
   public MaDetalleasistencia getSelected() {
      if (current == null) {
         ...
         current.setMaDetalleasistenciaPK(new co.edu.unicauca.gymadmdoc.entities.MaDetalleasistenciaPK());
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public MaDetalleasistencia getMaDetalleasistencia(co.edu.unicauca.gymadmdoc.entities.MaDetalleasistenciaPK id) {
   ...
   public static class MaDetalleasistenciaControllerConverter implements Converter {
      ...
      co.edu.unicauca.gymadmdoc.entities.MaDetalleasistenciaPK getKey(String value) {
         co.edu.unicauca.gymadmdoc.entities.MaDetalleasistenciaPK key;
         String values[] = value.split(SEPARATOR_ESCAPED);
         key = new co.edu.unicauca.gymadmdoc.entities.MaDetalleasistenciaPK();
      ...
      String getStringKey(co.edu.unicauca.gymadmdoc.entities.MaDetalleasistenciaPK value) {
