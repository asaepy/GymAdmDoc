...
import com.unicauca.gymadmdoc.sessionbeans.UsuarioMedicamentoFacade;
...
public class UsuarioMedicamentoController implements Serializable {
   ...
   @EJB
   private com.unicauca.gymadmdoc.sessionbeans.UsuarioMedicamentoFacade ejbFacade;
   ...
   public UsuarioMedicamento getSelected() {
      if (current == null) {
         ...
         current.setUsuarioMedicamentoPK(new com.unicauca.gymadmdoc.entities.UsuarioMedicamentoPK());
         selectedItemIndex = -1;
      }
      return current;
   }
   ...
   public UsuarioMedicamento getUsuarioMedicamento(com.unicauca.gymadmdoc.entities.UsuarioMedicamentoPK id) {
   ...
   public static class UsuarioMedicamentoControllerConverter implements Converter {
      ...
      public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        com.unicauca.gymadmdoc.entities.UsuarioMedicamentoPK getKey(String value) {
            com.unicauca.gymadmdoc.entities.UsuarioMedicamentoPK key;
         String values[] = value.split(SEPARATOR_ESCAPED);
         key = new com.unicauca.gymadmdoc.entities.UsuarioMedicamentoPK();
         key.setUsuIdentificacion(Long.parseLong(values[0]));
         key.setMedId(Integer.parseInt(values[1]));
         return key;
      }

      String getStringKey(com.unicauca.gymadmdoc.entities.UsuarioMedicamentoPK value) {
